...
static const Key keys[] = {
    ...
    {0,               XF86XK_MonBrightnessDown, spawn,  SHCMD("xbacklight -inc 7")},
    {0,                 XF86XK_MonBrightnessUp, spawn,  SHCMD("xbacklight -dec 7")},
    {0,                                  XK_F2, spawn,  SHCMD("brightnessctl s 10%+")},
    {0,                                  XK_F3, spawn,  SHCMD("brightnessctl s 10%-")},
    {0,                                  XK_F6, spawn,  SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +10%")},
    {0,                                  XK_F7, spawn,  SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%")},
    {0,                                  XK_F8, spawn,  SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle")},
    {0,                                  XK_F9, spawn,  SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle")},
    ...
    { MODKEY|ControlMask,               XK_space,   togglefloatingall, {0} },
